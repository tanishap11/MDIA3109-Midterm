...
const ProcessBtn = styled.button`
    min-width: ${props=>props.width ? props.width : "90px"};
    min-height: ${props=>props.height ? props.height: "28px"};
    border: ${props=>props.bdcolor ? "none" : "1px solid"+props.bdcolor};
    border-radius:5px;
    color:${props=>props.ftcolor ? "#F4F6F6" : props.ftcolor };
    background-color:${props=>props.bgcolor ? props.bgcolor: props.bgcolor};
`;
...
const Input_box = ({ width, height,text, bgcolor, bdcolor, ftcolor}) => {
    ...
    return <Container width={width} height={height}>
        ...
        <ProcessBtn bgcolor={bgcolor} bdcolor={bdcolor} ftcolor={ftcolor} >Pending</ProcessBtn>
        <ProcessBtn bgcolor={bgcolor} bdcolor={bdcolor} ftcolor={ftcolor} >In-Progress</ProcessBtn>
        <ProcessBtn bgcolor={bgcolor} bdcolor={bdcolor} ftcolor={ftcolor} >Pending</ProcessBtn>
