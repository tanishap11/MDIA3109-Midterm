...
const ProcessBtn = styled.button`
    ...
    &:focus{
        background-color:${require(props.bgcolor)}
    }
`;
...
const Input_box = ({ width, height,text, bgcolor, bdcolor, ftcolor}) => {
    ...
    return <Container width={width} height={height}>
        ...
        <ProcessBtn bgcolor={bgcolor} bdcolor={Pending} ftcolor={Pending} >Pending</ProcessBtn>
        <ProcessBtn bgcolor={bgcolor} bdcolor={Progress} ftcolor={Progress} >In-Progress</ProcessBtn>
        <ProcessBtn bgcolor={bgcolor} bdcolor={Completed} ftcolor={Completed} >Completed</ProcessBtn>
