        ...
        <InputRow>
            ...
            <div>
                <span className="checks">
                    <FilterCheckbox onChange={(e)=>{
                        setCheck3(e.target.checked);
                    }} checked={check1} /> Beagle
                </span>
                <span className="checks">
                    <FilterCheckbox onChange={(e)=>{
                        setCheck3(e.target.checked);
                    }} checked={check2} /> Pomeranian
                </span>
                <span className="checks">
                    <FilterCheckbox onChange={(e)=>{
                        setCheck3(e.target.checked);
                    }} checked={check3} /> Husky
                </span>
                <span className="checks">
                    <FilterCheckbox onChange={(e)=>{
                        setCheck3(e.target.checked);
                    }} checked={check3} /> Shiba
                </span>
                <span className="checks">
                    <FilterCheckbox onChange={(e)=>{
                        setCheck3(e.target.checked);
                    }} checked={check3} /> Shih Tzu
                </span>
            </div>
        </InputRow>
        <InputRow>
            ...
            <div>
                <span className="checks">
                    <FilterCheckbox onChange={(e)=>{
                        setCheck3(e.target.checked);
                    }} checked={check1} /> Pending
                </span>
                <span className="checks">
                    <FilterCheckbox onChange={(e)=>{
                        setCheck3(e.target.checked);
                    }} checked={check2} /> In Progress
                </span>
                <span className="checks">
                    <FilterCheckbox onChange={(e)=>{
                        setCheck3(e.target.checked);
                    }} checked={check3} /> Completed
                </span>
            </div>
        </InputRow>
